# Search and Classification of Ornaments in Lute Tablature
...
To run this code it is recommended to use a virtual environment with Python 3.13.3. 
After setting this up and activating it, install the required libraries.
The commands are given for Unix-systems.
